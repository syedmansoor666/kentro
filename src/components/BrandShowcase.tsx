      ...
      <div className="container">
        ...
        <div className="section-header">
          ...
          <h2 className="section-title">
            <span className="gradient-text-cyan">Kent</span> & <span className="gradient-text-copper">Pureit</span> RO Service in Bangalore
          </h2>
          <p className="section-subtitle">
            Specialized doorstep care for Bangalore&apos;s two most trusted purifier brands. Our technicians carry genuine model-specific replacement filters, membranes, and diagnostics.
          </p>
        </div>
