    ...
    <aside aria-label="WhatsApp support">
      <a
        ...
        style={{
          ...
          boxShadow: "0 8px 25px rgba(18, 140, 126, 0.5), 0 0 20px rgba(37, 211, 102, 0.35)",
          border: "2px solid rgba(255, 255, 255, 0.25)",
          transition: "all 0.3s cubic-bezier(0.16, 1, 0.3, 1)",
          textDecoration: "none",
        }}
        className="floating-whatsapp-btn"
        aria-label="Chat on WhatsApp with Bangalore RO Care"
      >
      ...
      <style jsx>{`
        ...
        .floating-whatsapp-btn:hover {
          ...
          box-shadow: 0 12px 30px rgba(18, 140, 126, 0.65), 0 0 25px rgba(37, 211, 102, 0.5);
        }
